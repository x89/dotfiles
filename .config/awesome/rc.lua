-- Lua config based on Arch Linux default 
...
local xdg_menu = require("xdg_menu")
...
local run_weechat = awful.util.spawn_with_shell(terminal .. " -e weechat -name WeeChat \
	-iconFile /usr/share/icons/hicolor/32x32/apps/weechat.png")
...
pacupdates = wibox.widget.textbox()
...
vicious.register(pacupdates, vicious.widgets.pkg, "<span color='gray'> Upd: </span> $1 ", 1800, 'Arch C')
