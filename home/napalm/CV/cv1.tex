...
\begin{outerlist}
	...
	\begin{innerlist}
		...
		\item Technologies include: Docker, Qemu/KVM, OpenVPN, Puppet, Python, Perl, Bash, AWS (Cloud Formation, EC2, S3, ...), CloudFlare, Git, MySQL, PostgreSQL, Nginx/Apache/uwsgi, etc
		\item Duties include: migration, configuration and set-up, security, service optimisation, monitoring, benchmarking, auto-scaling, networking, etc
	\end{innerlist}
\end{outerlist}
...
\begin{innerlist}
	...
	\item Always up to date with the latest technologies in my field
\end{innerlist} 
