...
{\hspace*{-\marginparsep minus \marginparwidth}%
	...
	\begin{document}
		...
		\begin{tabular}[t]{@{}p{\textwidth-\rcollength}p{\rcollength}}
			...
			Edinburgh		& \textit{Email:} \email{david@vaunt.eu} \\
			EH11 1HB				& \textit{DoB:} January 1990 \\
		...
		\vspace{-8mm}
		\begin{outerlist}
			\item[] \textbf{DevOps Engineer, \href{https://www.toptal.com/\#employ-only-on-the-ball-software-freelancers-now}{Toptal}} \\
			\textit{October 2016 ongoing}
%			\begin{innerlist}
%				\item Working with clients
%			\end{innerlist}
